...
class Way:
    ...
    def split(self, dividers):
        # slice the node-array using this nifty recursive function͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ...
        # create a way object for each node-array slice͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ret = []
        i=0
        for slice in slices:
...
class OSM:
    def __init__(self, filename_or_stream):
        ...
        #count times each node is used͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ...
        #use that histogram to split all ways, replacing the member set of ways͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        new_ways = {}
