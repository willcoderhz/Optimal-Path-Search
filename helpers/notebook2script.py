# Credits: https://github.com/fastai/course-v3/tree/master/nbs/dl2͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
...
#################################################
# file to edit: {fname}͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
...
'''
    ...
    # remove trailing spaces͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
