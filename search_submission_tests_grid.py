...
def save_graph(graph, file_name, show_edge_labels=False, show_node_labels=False, color_values=None):
    ...
    """
    # initialize Figure͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    ...
    #cut = 1.00͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    #xmax = cut * max(xx for xx, yy in pos.values())͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    #ymax = cut * max(yy for xx, yy in pos.values())͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    #plt.xlim(0, xmax)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    #plt.ylim(0, ymax)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
...
def create_grid(size=20, randomize_weights=False, file_name='grid_test.gpickle'):
    ...
    """
    # Create simple grid͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
...
class TestSearchExperimental(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Use this function to create any custom grid͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        #create_grid(20, file_name=file_name)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    ...
    def test_grid_viz_bidirectional_search(self):
        ...
        # path = bidirectional_a_star(self.grid, coordinates[0], coordinates[1], heuristic=custom_heuristic)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        ...
        * Nodes in path : Green
        ...
        # Color of nodes gets lighter as it gets explored more͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
    ...
    def test_grid_viz_tridirectional_search(self):
        ...
        # path = tridirectional_upgraded(self.grid, coordinates, heuristic=custom_heuristic)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        # path = three_bidirectional_search(self.grid, coordinates, heuristic=custom_heuristic)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄉͏󠄈͏︁
        explored = list({k: v for k, v in self.grid.explored_nodes().items() if v > 0})
